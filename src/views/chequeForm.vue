  ...
  <div id="app">
    ...
    <div class="chequeBack">
      ...
      <div  id="chequeBack" style="float: left; width: 768px; height: 287px; border: 0px solid blue">
          ...
          <input type="text" class="txt00 txtPayTo" v-model="txtPayTo"  :style="{'height':'20px', 'margin': '75px 0px 0px 105px', 'width': '440px', 'float': 'left', 'font-size': txtFont+'px'}"/>
...
export default {
  ...
  watch: {        // Changing Page Title
    $route: {
        immediate: true,
        handler(to) {
            document.title = to.meta.title || 'Metrobank Cheque';
        }
    },
  },
  data(){
